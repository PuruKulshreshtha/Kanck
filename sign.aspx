...
<body runat="server" >
    <div runat="server">
        ...
        <img src="images/bg-01.jpg" class="im2" alt="" >    
        <asp:HyperLink ID="HyperLink1" NavigateUrl="website/index.aspx" runat="server">
            <img src="website/images/logo.png" alt="" class="im1" >
