<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="New_Admin.aspx.cs" Inherits="mimi2.New_Admin" %>
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" runat="server">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter password">
                        <asp:TextBox CssClass="input100" ID="TextBox3" runat="server" Type="password" placeholder="Enter Admin Code"></asp:TextBox>
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>

					<div class="container-login100-form-btn m-t-32" runat="server">
                        <asp:Button CssClass="login100-form-btn" ID="Button1" runat="server" Text="Create" OnClick="Button1_Click" />
